...
An example of an AVS in the oracle space is [RedStone AVS](/docs/network-tokenomics/restaking-avs/redstone-avs), which utilizes this model to provide secure and reliable oracle services.
